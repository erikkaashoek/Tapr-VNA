...
//				}
				ReflDetailMagPhOpen[i, MagQ] = RxBuf->ReflMQ; // Median7(BufferM);
				ReflDetailMagPhOpen[i, PhaseI] = RxBuf->ReflPI; // Median7(BufferI);		// filter the raw readings
				ReflDetailMagPhOpen[i, PhaseQ] = RxBuf->ReflPQ; // Median7(BufferQ);
...
//					BufferM[k] = RxBuf->ReflMQ;
//				}
				ReflDetailMagPhShort[i, MagQ] = RxBuf->ReflMQ; // Median7(BufferM);
				ReflDetailMagPhShort[i, PhaseI] = RxBuf->ReflPI; // Median7(BufferI);		// filter the raw readings
				ReflDetailMagPhShort[i, PhaseQ] = RxBuf->ReflPQ; // Median7(BufferQ);
...
//				{
                    if (!VNA->WriteRead(TxBuf, RxBuf, DIR_REFL)) {
						TxLongCableOpenStat->Image = ICO2Label->Image;				// 'x'
...
//					BufferM[k] = RxBuf->ReflMQ;
//				}
				ReflLongDetailMagPhOpen[i, MagQ] = RxBuf->ReflMQ; // Median7(BufferM);
				ReflLongDetailMagPhOpen[i, PhaseI] = RxBuf->ReflPI; // Median7(BufferI);		// filter the raw readings
				ReflLongDetailMagPhOpen[i, PhaseQ] = RxBuf->ReflPQ; // Median7(BufferQ);
...
//				{
                    if (!VNA->WriteRead(TxBuf, RxBuf, DIR_REFL)) {
						TxLongCableShortStat->Image = ICO2Label->Image;				// 'x'
...
//					BufferM[k] = RxBuf->ReflMQ;
//				}
				ReflLongDetailMagPhShort[i, MagQ] = RxBuf->ReflMQ; // Median7(BufferM);
				ReflLongDetailMagPhShort[i, PhaseI] = RxBuf->ReflPI;// Median7(BufferI);		// filter the raw readings
				ReflLongDetailMagPhShort[i, PhaseQ] = RxBuf->ReflPQ; // Median7(BufferQ);
