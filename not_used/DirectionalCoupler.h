...
DirectionalCoupler(void);	// constructor
...
double DirectionalCoupler::PeriodicModelCorrection(int frequency, double phase, array<PerErrModelCoeff^>^ PerErrModelCoeff,
		double DCOffset);
